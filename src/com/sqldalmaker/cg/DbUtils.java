...
//		if (onlySlqFiles) {
//
//			if (Helpers.isSqlFileRef(ref)) {
//
//				String sqlPathFile = Helpers.concat_path(sql_root_abs_path, ref);
//				return Helpers.loadTextFromFile(sqlPathFile);
//
//			} else {
//
//				throw new Exception("Invalid name of SQL-file: " + ref);
//			}
//
//		} else
        {
    ...
    public void get_crud_info(String table_name, ArrayList<FieldInfo> columns, List<FieldInfo> params,
        ...
        Set<String> key_col_names_set = new HashSet<String>();

        for (String colName : pk) {

            key_col_names_set.add(colName);
        }
        ...
        try {
            ...
            for (int i = 1; i <= column_count; i++) {
                ...
                if (key_col_names_set.contains(col_name)) {
    ...
    public static ResultSet get_tables(Connection conn, DatabaseMetaData db_info, String root, boolean include_views) throws SQLException {
