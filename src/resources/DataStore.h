...
Implemented with SQLite C Library and ATL/MFC. 
...
public:
	...
	// no params: params_count == 0 and params == 0
	// returns the number of fetched rows or -1 on error
	int queryRowList(DL_STR sql, int params_count, CValue* params[], int ret_values_count, CValue* ret_values[], DL_STR col_names[],
	    CRowProcessor *rowProcessor);
};
