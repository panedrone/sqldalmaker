...
bool CDataStore::open() {
    ...
    // db.setDatabaseName("e:\\thesaurus.sqlite");
...
bool CDataStore::prepare(const QString &sql, QSqlQuery &query, int params_count, CValue *params[]) {
...
bool CDataStore::readRowData(QSqlQuery &query, int ret_values_count, CValue *ret_values[], DL_STR col_names[]) {
