...
public class EclipseConsoleHelpers {
	...
	public static void add_error_msg(String clazz, String msg) {
		...
		out.println(String.format("[ERROR]%n%n") + clazz + ": " + msg + String.format("%n"));

		// myConsole.activate();
		bring_to_front(my_console); // === console (tab) may be created, but console view is hidden and located
		// behind other consoles
	}
